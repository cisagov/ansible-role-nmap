...
issue](https://github.com/cisagov/ansible-role-nmap/issues) in this
...
request](https://github.com/cisagov/ansible-role-nmap/pulls), you will
...
```console
cd ansible-role-nmap
pyenv virtualenv <python_version_to_use> ansible-role-nmap
pyenv local ansible-role-nmap
